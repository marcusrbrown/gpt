    ...
    <Modal isOpen={isOpen} onClose={onClose} size="md">
      <ModalHeader className="flex flex-col gap-1">
        <div className="flex items-center gap-2">
          {isBulkExport ? <Package className="w-5 h-5 text-primary" /> : <FileJson className="w-5 h-5 text-primary" />}
      ...
      <ModalBody className="gap-6">
        ...
        <div className="space-y-2">
          ...
          <div className={cn('bg-surface-secondary rounded-lg p-4 border-2 border-primary', 'flex items-center gap-3')}>
            {isBulkExport ? (
              <>
