      ...
      <div className={cn('p-3 border-b flex justify-between items-center gap-2', isLoading && ds.state.loading)}>
        <div className="flex-1">
          <Input
            ...
            className={cn(ds.focus.ring, ds.animation.transition, ds.animation.formFocus)}
        ...
        <div className="flex gap-2">
          <Tooltip content="Save conversation">
            <Button
              ...
              className={cn(ds.focus.ring, ds.animation.transition, ds.animation.buttonPress)}
            >
      ...
      <div className={cn('p-3 border-t', isLoading && ds.state.loading)}>
        ...
        >
          <Input
            ...
            className={cn('flex-1', ds.focus.ring, ds.animation.transition, ds.animation.formFocus)}
